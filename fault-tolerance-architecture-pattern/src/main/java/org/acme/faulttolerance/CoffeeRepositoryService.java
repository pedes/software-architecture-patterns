...
public class CoffeeRepositoryService {
    ...
    public CoffeeRepositoryService() {
        coffeeList.put(1, new Coffee(1, "Fernandez Espresso", "Colombia", 100));
        coffeeList.put(2, new Coffee(2, "La Scala Whole Beans", "Bolivia", 80));
        coffeeList.put(3, new Coffee(3, "Dak Lak Filter", "Vietnam", 85));
    ...
    public Integer getAvailabilityFallback(Coffee defaultCoffee){
        return 0;
    }
}
